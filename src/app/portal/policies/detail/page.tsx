...
const PolicyDetailPage = () => {
  ...
  const isVehicle =
    !!policyDetail &&
    !!(['car' | 'motorcycle'] as PolicyType[]).indexOf(
    ...
    <div>
      <div className='mb-6 flex flex-wrap items-center justify-between gap-4'>
        ...
        <div className='flex gap-3'>
          <button className='bg-background flex h-9 items-center justify-center gap-2 whitespace-nowrap rounded-md border border-[#02ADEF] px-4 py-2 font-body text-sm font-medium leading-none text-[#02ADEF] transition-all hover:bg-[#02ADEF] hover:text-white'>
            <DownloadOutlined className='h-4 w-4' />
            Download Policy Schedule
          </button>
          {isPendingRenewal && (
            <button className='h-9 whitespace-nowrap rounded-md bg-[#52c41a] px-4 py-2 font-body text-sm font-medium leading-none text-white outline-none transition-all hover:bg-[#52c41a]/90 disabled:pointer-events-none disabled:opacity-50'>
              Renew Now
            </button>
          )}
        </div>
