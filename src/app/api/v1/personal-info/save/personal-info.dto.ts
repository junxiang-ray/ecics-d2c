...
export const savePersonalInfoDTOSchema= z.object({
  ...
  gender: z.string().min(1, "Vehicle make is required"),
  nric: z.string().min(1, "NRIC is required"),
  marital_status: z.string().min(1, "Vehicle make is required"),
  date_of_birth: z.string(),
  address: z.string().min(1, "Address is required"),
  vehicle_make: z.string().min(1, "Vehicle make is required"),
  vehicle_model: z.string().min(1, "Vehicle model is required"),
  year_of_registration: z.string().min(1, "Year of registration is required"),
