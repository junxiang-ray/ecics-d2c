...
const VehiclePolicyDetail = ({ data }: Props): JSX.Element | null => {
  if (!data) return null;
  ...
  return (
    <Card
      ...
      subTitle='Motor vehicle policy information'
      icon={<DocumentOutlined width='21' height='21' />}
    >
      <div className='grid grid-cols-1 gap-x-8 gap-y-5 md:grid-cols-2'>
        {row('Policy Number', data.policy_no)}
        {row('Type of Policy', data.policy_type_name)}
