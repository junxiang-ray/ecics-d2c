...
const MotorcycleItem: React.FC<MotorcycleItemProps> = ({
  promoCode,
  discount,
  description,
  isMobile,
    ...
    <div className='relative z-10 mx-auto max-w-md px-4'>
      ...
      >
        ...
        <div className='text-justify text-sm'>
          ...
          <span className='font-bold'>{discount}%</span> on Motorcycle
          Insurance. Use the code below before this deal runs out of road.
        </div>
